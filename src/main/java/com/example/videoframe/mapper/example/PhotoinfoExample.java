...
public class PhotoinfoExample {
    ...
    public PhotoinfoExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public PhotoinfoExample orderBy(String ... orderByClauses) {
    ...
    public PhotoinfoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public PhotoinfoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private PhotoinfoExample example;

        protected Criteria(PhotoinfoExample example) {
            super();
            this.example = example;
        }

        public PhotoinfoExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(PhotoinfoExample example);
    }
}